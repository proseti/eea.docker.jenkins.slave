...
- [`:3.14` (*Dockerfile*)](https://github.com/eea/eea.docker.jenkins.slave/blob/3.14/Dockerfile)
- [`:3.12` (*Dockerfile*)](https://github.com/eea/eea.docker.jenkins.slave/blob/3.12/Dockerfile)
- [`:3.6.1` (*Dockerfile*)](https://github.com/eea/eea.docker.jenkins.slave/blob/3.6.1/Dockerfile)
